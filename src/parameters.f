...
real(kind=dp), parameter :: KeplerianPeriod = 0.010_dp/365.0_dp !0.050000_dp !years
...
real(kind=dp), parameter :: MBH = 2.20e3_dp !BH mass in solar masses
...
!For GW calcs
real(kind=dp), parameter :: observer_distance = 4.0e3_dp !parsecs
