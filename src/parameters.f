...
real(kind=dp), parameter :: circular = 1 !Turn on/off a precessing circular orbit. If on subsequent parameters are ignored
...
real(kind=dp), parameter :: N_orbit = 4.0_dp !Number of orbits to integrate
